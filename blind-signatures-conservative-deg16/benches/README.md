...
```bash
export LD_LIBRARY_PATH=../mayo-c-sys/target/debug:../vole-keccak-then-mayo-sys/target/debug:$LD_LIBRARY_PATH
cargo flamegraph --bench blind_sig_conservative_deg16 --freq 1000 --output flamegraph.svg
```
